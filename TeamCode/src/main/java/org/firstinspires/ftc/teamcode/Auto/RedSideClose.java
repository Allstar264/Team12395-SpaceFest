...
@Autonomous(name="Red Close Pedro", group="Auto")
public class RedSideClose extends LinearOpMode {
    ...
    private final Pose end1stSpike = poseFactory.of(122.5, 82, 0);
    ...
    private final Pose gate = poseFactory.of(125, 57.75, 25);
    ...
    private final Pose gate2 = poseFactory.of(125, 57.75, 25);
