...
@Autonomous(name="15RedBack", group="Auto")
public class Red15Far extends LinearOpMode {
    ...
    private final Pose point61stTunnelIntake = poseFactory.of(132.5, 10, 0);
    ...
    private final Pose point82ndTunnelIntake = poseFactory.of(132.5, 10, 0);
